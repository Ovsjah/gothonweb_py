...
Lbne zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf nebhaq gur ubhfr.
...
escape_pod.add_paths({
    escape_pod.right_one : the_end_winner,
    '*': the_end_loser
})
...
the_bridge.add_paths({
    'player throw bomb': generic_death,
...
central_corridor.add_paths({
    'player shoot': generic_death,
    'player dodge': generic_death,
